...
/**
 * {@link EventBusSubscriber.BusEvent} that is dispatched <b>before</b> a user
 * change is performed; therefore giving subscribers the possibility to
 * {@link #decline()} the user change.
 * <p>
...
public final class UserChangeAnnouncementEvent extends EventBusSubscriber.BusEvent {
	...
	/**
	 * Returns whether the announced user change should cause an refresh when it is
	 * executed.
	 *
